Feature: Manage line_items
  ...
  Scenario: View line_item
    ...
    Then the show line_item information should be properly populated
    And I should see "Create associated campaign"

  Scenario: Edit line_item
    Given the standard ad-hoc campaign and associated entities exist
    And I am on the new line_item page
    When I follow "Ford Spring" 
    Then the show line_item information should be properly populated
    And I should see "Edit Line Item"
    And I should see "Create associated campaign"
